...
export const roles: readonly Role[] = [
  ...
  { slug: "mecanizada", name: "Tripulante de Mecanizada", branch: "Roles Tecnicos", level: "Basico",image: "/images/roles/mecanizado.webp",
    next_levels:["Comandante de mecanizada"], description:"El tripulante de mecanizada opera y mantiene vehiculos blindados de combate, encargandose de tareas como la conduccion, el manejo de armamento o la comunicacion dentro del vehiculo.\n Su funcion es esencial para brindar potencia de fuego, proteccion y movilidad a la infanteria durante las operaciones." },  
  { slug: "movilidad-ligera", name: "Artillero de Movilidad Ligera", branch: "Roles Tecnicos", level: "Basico", image: "/images/roles/movilidad-ligera.png",
    next_levels:["Conductor de Movilidad Ligera", "Cabeza de Convoy"], description:"El artillero de movilidad ligera opera el armamento montado sobre vehiculos ligeros, brindando apoyo de fuego movil y proteccion al convoy durante desplazamientos y operaciones.\n Su funcion exige coordinacion constante con el conductor y el resto de la tripulacion para reaccionar rapidamente ante amenazas mientras el vehiculo esta en movimiento." },  
